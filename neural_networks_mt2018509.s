;IMPORTANT: Files needed for running: neural_networks.s and printmsg.c only     
...
;For a not gate, only inputs a and c are used to calculate the argument to the sigmoid function. b is ignored.
...
__main  FUNCTION
	 ...
	 VLDR.F32 s22,=0;input c in s22
	 MOV r5,#0;To have input combinatons count
	 MOV r6,#1
	 ...
	 ;ret routine takes care of changing inputs and calling AND gate
	 ;ret1 routine takes care of changing inputs and calling OR gate
	 ;ret2 routine takes care of changing inputs and calling NOT gate
	 ;ret3 routine takes care of changing inputs and calling NAND gate
	 ;ret4 routine takes care of changing inputs and calling NOR gate
ret	 CMP r5,#0
     BEQ input0
     ;ADD r5,r5,r6
     CMP r5,#1
     ...
     CMP r5,#3
 	 BEQ input3
	 CMP r5,#4
	 MOV r5,#0	 ;if all input combinations exhausted, reset r5 and move to the next gate
     BEQ ret1
;0th input combination input0
;1st is input1
;2nd is input2
;3rd is input3
;The input combination count r5 is incremented in the "check" routine
input0 VLDR.F32 s21,=0;input b in s21
	   VLDR.F32 s22,=0;input c in s22
	   VCVT.U32.F32 s24,s21;conversion for printing and moving 'b' to s24
	   VCVT.U32.F32 s25,s22;conversion for printing and moving 'c' to s25
...
input1 VLDR.F32 s21,=0
       VLDR.F32 s22,=1
	   VCVT.U32.F32 s24,s21;conversion for printing and moving 'b' to s24
	   VCVT.U32.F32 s25,s22;conversion for printing and moving 'c' to s25
	   B and1
	 
input2 VLDR.F32 s21,=1
       VLDR.F32 s22,=0
	   VCVT.U32.F32 s24,s21;conversion for printing and moving 'b' to s24
	   VCVT.U32.F32 s25,s22;conversion for printing and moving 'c' to s25
	   B and1
	   
input3 VLDR.F32 s21,=1
       VLDR.F32 s22,=1
	   VCVT.U32.F32 s24,s21;conversion for printing and moving 'b' to s24
	   VCVT.U32.F32 s25,s22;conversion for printing and moving 'c' to s25
	   B and1
;ret1 responsible to changing inputs and calling and gate
ret1 
     CMP r5,#0
     BEQ input0a
     ;ADD r5,r5,r6
...
input0a VLDR.F32 s21,=0;input b in s21
	   VLDR.F32 s22,=0;input c in s22
	   VCVT.U32.F32 s24,s21;conversion for printing and moving 'b' to s24
	   VCVT.U32.F32 s25,s22;conversion for printing and moving 'c' to s25
...
input1a VLDR.F32 s21,=0
       VLDR.F32 s22,=1
	   VCVT.U32.F32 s24,s21;conversion for printing and moving 'b' to s24
	   VCVT.U32.F32 s25,s22;conversion for printing and moving 'c' to s25
	   B or
	 
input2a VLDR.F32 s21,=1
       VLDR.F32 s22,=0
	   VCVT.U32.F32 s24,s21;conversion for printing and moving 'b' to s24
	   VCVT.U32.F32 s25,s22;conversion for printing and moving 'c' to s25
	   B or
	   
input3a VLDR.F32 s21,=1
       VLDR.F32 s22,=1
	   VCVT.U32.F32 s24,s21;conversion for printing and moving 'b' to s24
	   VCVT.U32.F32 s25,s22;conversion for printing and moving 'c' to s25
	   B or

;ret2 responsible to changing inputs and calling not gate
ret2  
     CMP r5,#0
     BEQ input0b
     ;ADD r5,r5,r6
...
input0b VLDR.F32 s21,=0;input b in s21
	   VLDR.F32 s22,=0;input c in s22
	   VCVT.U32.F32 s24,s21;conversion for printing and moving 'b' to s24
	   VCVT.U32.F32 s25,s22;conversion for printing and moving 'c' to s25
...
input1b VLDR.F32 s21,=0
       VLDR.F32 s22,=1
	   VCVT.U32.F32 s24,s21;conversion for printing and moving 'b' to s24
	   VCVT.U32.F32 s25,s22;conversion for printing and moving 'c' to s25
	   B not
;ret3 responsible to changing inputs and calling nand gate
ret3 CMP r5,#0
     BEQ input0c
     ;ADD r5,r5,r6
     CMP r5,#1
...
input0c VLDR.F32 s21,=0;input b in s21
	   VLDR.F32 s22,=0;input c in s22
	   VCVT.U32.F32 s24,s21;conversion for printing and moving 'b' to s24
	   VCVT.U32.F32 s25,s22;conversion for printing and moving 'c' to s25
...
input1c VLDR.F32 s21,=0
       VLDR.F32 s22,=1
	   VCVT.U32.F32 s24,s21;conversion for printing and moving 'b' to s24
	   VCVT.U32.F32 s25,s22;conversion for printing and moving 'c' to s25
	   B nand
	 
input2c VLDR.F32 s21,=1
       VLDR.F32 s22,=0
	   VCVT.U32.F32 s24,s21;conversion for printing and moving 'b' to s24
	   VCVT.U32.F32 s25,s22;conversion for printing and moving 'c' to s25
	   B nand
	   
input3c VLDR.F32 s21,=1
       VLDR.F32 s22,=1
	   VCVT.U32.F32 s24,s21;conversion for printing and moving 'b' to s24
	   VCVT.U32.F32 s25,s22;conversion for printing and moving 'c' to s25
	   B nand
;ret4 responsible to changing inputs and calling nor gate
ret4 CMP r5,#0
     BEQ input0d
     ;ADD r5,r5,r6
     CMP r5,#1
     ...
     CMP r5,#3
 	 BEQ input3d
	 CMP r5,#4
	 MOV r5,#0;if all input combinations exhausted, halt the program execution
     BEQ stop
	 
input0d VLDR.F32 s21,=0;input b in s21
	   VLDR.F32 s22,=0;input c in s22
	   VCVT.U32.F32 s24,s21;conversion for printing and moving 'b' to s24
	   VCVT.U32.F32 s25,s22;conversion for printing and moving 'c' to s25
...
input1d VLDR.F32 s21,=0
       VLDR.F32 s22,=1
	   VCVT.U32.F32 s24,s21;conversion for printing and moving 'b' to s24
	   VCVT.U32.F32 s25,s22;conversion for printing and moving 'c' to s25
	   B nor
	 
input2d VLDR.F32 s21,=1
       VLDR.F32 s22,=0
	   VCVT.U32.F32 s24,s21;conversion for printing and moving 'b' to s24
	   VCVT.U32.F32 s25,s22;conversion for printing and moving 'c' to s25
	   B nor
	   
input3d VLDR.F32 s21,=1
       VLDR.F32 s22,=1
	   VCVT.U32.F32 s24,s21;conversion for printing and moving 'b' to s24
	   VCVT.U32.F32 s25,s22;conversion for printing and moving 'c' to s25
	   B nor;Branches to nor gate neural network
...
check  ADD r5,r5,r6;r5 incremented to move to the next input combination
       VCMP.F32 s12,s29 ;checking if s12>0.5, s29 is initialised with 0.5
...
nor  VLDR.F32 s0,=0.5;wa
	 ...
	 BL check;called to assign logic 1 or logic 0 to output
	 BL printMsg4p;called to print the input output values
	 B ret4;Branches to stop as all logic gates are done
